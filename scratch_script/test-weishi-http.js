async function run() {
  ...
  const testEndpoints = [
    `http://isee.weishi.qq.com/ws/app-pages/share/index.html?id=${id}`,
    `http://m.weishi.qq.com/vise/share/index.html?id=${id}`,
    `https://weishi.v.qq.com/weishi/feed/profile/${id}`
  ];
