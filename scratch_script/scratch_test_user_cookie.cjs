...
async function testWithUserCookie(fid) {
  console.log("Testing Weibo Component POST with user Cookie for fid:", fid);
...
testWithUserCookie("1034:5326514065965150");
